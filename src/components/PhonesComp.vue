    ...
    <div class="container mx-auto">
      ...
      <div class="flex flex-wrap items-start justify-between">
        ...
        >
          ...
          <p v-if="phone.discount != null" class="text-2xl font-semibold text-mainCol">{{ phone.price - (phone.price * phone.discount) / 100 }} тг.</p>
          <p v-if="phone.discount != null" class="text-xs font-semibold line-through text-grayText">{{ phone.price }} тг.</p>
          <p v-if="phone.discount == null" class="text-2xl font-semibold">{{ phone.price }} тг.</p>
        </div>
      </div>
    </div>
  </div>
